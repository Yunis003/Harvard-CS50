...
int main(int argc, char *argv[])
{
    ...
    // create n for the resize
    int scale = atoi(argv[1]);

    // check n
    if (scale > 100 || scale < 1)
    {
        printf("Scale must be a positive int elss than or equal to 100\n");
        return 1;
    }
    ...
    // check infile is 24-bit uncompressed file
    ...
    // create original width and height
...
// Note: This code is a complete implementation of the resize program for BMP files.